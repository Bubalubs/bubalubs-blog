...
<template>
    <nav class="flex flex-col p-12 lg:text-center">
        ...
        <RouterLink
            ...
            server</RouterLink
        >
        <RouterLink class="mb-6" to="/stripe-3dsecure-2-checkout-using-setup-intent"
